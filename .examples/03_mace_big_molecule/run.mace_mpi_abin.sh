...
ABINEXE="/home/jakub/ABIN/bin/abin"  # Path to ABIN binary
# Path to MPICH installation.
MPI_PATH="/home/jakub/ABIN/mpich/4.3.2/install"

# MACE SETUP
MODEL_PATH=./MACE/MACE-OFF23_medium.model
...
# LAUNCH MACE SERVER
$MPIRUN -n 1 $MACE_PYTHON $MACE_SERVER --device "$MACE_DEVICE" --model-path "$MODEL_PATH" > "$MACE_OUTPUT" 2>&1 &
mace_pid=$!
...
$MPIRUN -n 1 $ABIN_CMD &> $ABIN_OUTPUT &
abin_pid=$!
